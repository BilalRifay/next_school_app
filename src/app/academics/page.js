...
export default function Academics() {
  ...
  return (
    <div className="min-h-screen bg-blue-800/80 text-white">
      ...
      {/* Academics Section */}
      <Section
        title={t("academics.sectionTitle")}
        extraClasses="bg-gray-100 text-gray-800"
      >
      ...
      <Section
        title={t("academics.schoolInfo.sectionTitle")}
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card
            ...
            description={t(
              "academics.schoolInfo.mediumOfInstruction.description"
            )}
          />
          <Card
            title={t("academics.schoolInfo.genderComposition.title")}
            description={t(
              "academics.schoolInfo.genderComposition.description"
            )}
          />
          <Card
      ...
      <div className="text-center py-8 px-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {Object.values(ImageLink)
          .slice(0, 8)
          .map((img, index) => (            <div key={index} className="w-full h-48 overflow-hidden">
              <picture>
                <img
                  src={img}
                  alt={`Image ${index + 1}`}
