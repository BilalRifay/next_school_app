...
console.log(events)
  ...
  const EventSection = ({ title, description, images }) => {
    ...
    return (
      <div
        ref={ref}
        className={`p-6 md:p-8 bg-gray-50 mb-8 transition-opacity duration-700 ${
      ...
      >
        ...
        <div className="relative w-full h-[300px] md:h-[400px] rounded-xl mb-6">
          {validImages[0] && (
            <div className="relative w-3/4 m-auto h-full">
              <Image
                src={validImages[0]}
                alt={title}
                layout="fill"
  ...
  return (
    <div className="font-sans">
      ...
      <div
        ref={headerRef}
        className={`relative text-center mb-12 p-8 bg-gradient-to-r from-teal-500 to-blue-600 shadow-lg transition-opacity duration-700 ${
      ...
      >
        ...
        <p className="relative text-lg md:text-xl text-white max-w-3xl mx-auto drop-shadow-sm">
          Explore our past and upcoming events where students engage, learn, and
          celebrate various academic, cultural, and extracurricular activities.
        </p>
      </div>
      <div>
